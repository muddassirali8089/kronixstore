                                            ...
                                            cartState.cartArray.map((product) => (
                                                <div className="item flex md:mt-7 md:pb-7 mt-5 pb-5 border-b border-line w-full" key={product.id}>
                                                    ...
                                                    <div className="w-1/6 flex items-center justify-center">
                                                        <div className="qty-block bg-surface md:p-3 p-2 flex items-center justify-between rounded-lg border border-line md:w-[100px] flex-shrink-0 w-20">
                                                            <Icon.Minus
                                                                onClick={() => {
                                                                    if (product.qty > 1) {
                                                                ...
                                                                className={`text-base max-md:text-sm ${product.qty === 1 ? 'disabled' : ''}`}
                                                            />
                                                            <div className="text-button qty">{product.qty}</div>
                                                            <Icon.Plus
                                                                onClick={() => handleQuantityChange(product.id, product.qty + 1)}
                                                                className='text-base max-md:text-sm'
                                                            />
                                                        </div>
                                                    </div>
                                                    <div className="w-1/6 flex total-price items-center justify-center">
                                                        <div className="text-title text-center">${product.qty * product.price}.00</div>
                                                    </div>
