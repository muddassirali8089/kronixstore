...
const Checkout = () => {
    ...
    cartState.cartArray.map(item => totalCart += item.price * item.qty)
                                ...
                                <div className="item flex items-center justify-between gap-6">
                                    <div className="flex items-center gap-6">
                                        <div className="bg_img relative flex-shrink-0 w-[100px] h-[100px]">
                                            <Image src="/images/product/1000x1000.png" alt="product/1000x1000" className="w-full h-full object-cover rounded-lg" width={100} height={100} />
                                            <span className="qty flex items-center justify-center absolute -top-3 -right-3 w-7 h-7 rounded-full bg-black text-white">1</span>
                                        </div>
                                        <div>
