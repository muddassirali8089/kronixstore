...
const Checkout = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [itemsResponse, categoriesResponse] = axios.get(
                      ...
                      <>
                        <div className="item flex items-center justify-between w-full pb-5 border-b border-line gap-6 mt-5">
                          <div className="bg-img w-[100px] aspect-square flex-shrink-0 rounded-lg overflow-hidden">
                            <Image
                              src={product.thumbImage?.[0] || "/fallback.jpg"} // replace with your default image path
                              width={500}
                              height={500}
                              alt="img"
