                    ...
                    <div className="header-main flex justify-between h-full">
                        ...
                        <div className="left flex items-center gap-16">
                            <Link href={'/'} className='flex items-center max-lg:absolute max-lg:left-1/2 max-lg:-translate-x-1/2'>
                                <div className="heading4">Kronixstore</div>
                            </Link>
                                ...
                                <ul className='flex items-center gap-8 h-full'>
                                    ...
                                    <li className='h-full'>
                                        <Link
                                            ...
                                            className={`text-button-uppercase duration-300 h-full flex items-center justify-center ${pathname === '/shop/breadcrumb1' ? 'active' : ''}`}
                                        >
                                            Shop
                                        </Link>
                                    </li>
                        ...
                        <div className="right flex gap-12">
                            ...
                            <div className="list-action flex items-center gap-4">
                                ...
                                <div className="cart-icon flex items-center relative cursor-pointer" onClick={openModalCart}>
                                    ...
                                    <span className="qty cart-qty absolute -right-1.5 -top-1.5 text-xs text-white bg-black w-4 h-4 flex items-center justify-center rounded-full">{cartState.cartArray.length}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>Kronixstore</Link>
                            </div>
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                    ...
                                    >
                                        <a href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Category
