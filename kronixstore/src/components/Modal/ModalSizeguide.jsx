...
const ModalSizeguide = ({ data, isOpen, onClose }) => {
    const [activeSize, setActiveSize] = useState('')
    const [heightRange, setHeightRange] = useState({ min: 100, max: 200 });
    const [weightRange, setWeightRange] = useState({ min: 30, max: 90 });
