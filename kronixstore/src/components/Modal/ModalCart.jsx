...
const ModalCart = ({ serverTimeLeft }) => {
    ...
    const handleAddToCart = (productItem) => {
        if (!cartState.cartArray.find(item => item.id === productItem.id)) {
            ...
            updateCart(productItem.id, productItem.min_qty, '', '')
        } else {
            updateCart(productItem.id, productItem.min_qty, '', '')
        }
    };
                                ...
                                <div key={product.id} className='item py-5 flex items-center justify-between gap-3 border-b border-line'>
                                    <div className="infor flex items-center gap-5">
                                        <div className="bg-img">
                                            <Image
                                                src={`https://api.kronixstore.com${product.images[0]}`}
                                                width={300}
                                                height={300}
                                                alt={product.name}
                                        ...
                                        <div className=''>
                                            ...
                                            <div className="flex items-center gap-2 mt-2">
                                                ...
                                                <div className="product-origin-price text-title text-secondary2"><del>${product.mrp}.00</del></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div className='w-full'>
                                            ...
                                            <div className="flex items-center justify-between gap-2 mt-3 w-full">
                                                <div className="flex items-center text-secondary2 capitalize">
                                                    {product.selectedSize || product.sizes[0]}/{product.selectedColor || product.variations[0].color}
                                                </div>
                                                <div className="product-price text-title">₹{product.price}</div>
                                            </div>
                                        </div>
